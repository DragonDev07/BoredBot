...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name = "Media", value = "To Control Media, Use the following commands.\n>join - Makes the bot join the vc that you are currently in.\n>leave - Makes the bot leave the vc it is in.\n>play - Unfinished Command, will make the bot play audio.\n>pause - Pauses currently playing audio.\n>resume - Resumes pasued audio.", inline = False)
